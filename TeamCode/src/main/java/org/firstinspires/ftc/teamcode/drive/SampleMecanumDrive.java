...
public class SampleMecanumDrive extends MecanumDrive
{
  ...
  public SampleMecanumDrive(HardwareMap hardwareMap, Telemetry telemetry)
  {
    ...
    leftFront = hardwareMap.get(DcMotorEx.class, "lFront + axial");
    leftRear = hardwareMap.get(DcMotorEx.class, "lRear + lLateral");
    rightRear = hardwareMap.get(DcMotorEx.class, "rRear");
    rightFront = hardwareMap.get(DcMotorEx.class, "rFront + rLateral");
    ...
    setLocalizer(new StandardTrackingWheelLocalizer(hardwareMap, lastTrackingEncPositions, lastTrackingEncVels, telemetry));
