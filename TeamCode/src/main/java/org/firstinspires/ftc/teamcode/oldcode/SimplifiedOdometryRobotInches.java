...
public class SimplifiedOdometryRobotInches
{
  ...
  public static double STRAFE_ACCEL = 1;       // Acceleration limit.  Percent Power change per second.  1.0 = 0-100% power in 1 sec.
  ...
  public ProportionalControlInches driveController = new ProportionalControlInches(DRIVE_GAIN, DRIVE_ACCEL, DRIVE_MAX_AUTO, DRIVE_TOLERANCE, DRIVE_DEADBAND, false);
  public ProportionalControlInches strafeController = new ProportionalControlInches(STRAFE_GAIN, STRAFE_ACCEL, STRAFE_MAX_AUTO, STRAFE_TOLERANCE, STRAFE_DEADBAND, false);
  public ProportionalControlInches yawController = new ProportionalControlInches(YAW_GAIN, YAW_ACCEL, YAW_MAX_AUTO, YAW_TOLERANCE, YAW_DEADBAND, true);
